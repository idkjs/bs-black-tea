...
If :code:`bs-black-tea` is available in your opam repository, you can just call::

  opam install bs-black-tea

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`bs-black-tea` in a directory.
